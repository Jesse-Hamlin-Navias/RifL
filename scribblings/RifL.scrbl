...
Auto-imperative means that RifL code represents a state, and then
augments its own state. The cards encode information and
can also encode instruction to transform that information.
...
as masking tape, a sharpie, a coin or token, and the documentation below.

The first chapter, @secref{Introduction}, teaches you how to read,
write, and execute RifL code both physically and on a computer.
The second chapter, @secref{Data}, explains how RifL turns cards into
numbers, words, and references. The third chapter, @secref{Royal}, thoroughly covers
how RifL can manipulate that data. The final chapter, @secref{Extras},
has RifL code examples, past and future development information,
